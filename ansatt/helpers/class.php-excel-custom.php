...
class Excel_XML
{
  ...
  <Style ss:ID=\"s72\">
   ...
   <NumberFormat ss:Format=\"Fixed\"/>
         ...
         */
        private function addRow ($array, $row_num)
        {
        	$cells = "";
                foreach ($array as $k => $v):
                        ...
                        $v = utf8_encode($v);
                        $cells .= "<Cell{$style}{$formula}>";
                        $cells .= "<Data ss:Type=\"$type\">" . $v . "</Data>";
                        $cells .= "</Cell>\n"; 
                endforeach;
                $this->lines[] = "<Row>\n" . $cells . "</Row>\n";
        }
        ...
        public function generateXML ($filename = 'excel-export')
        {
                ...
                $output .= '<Table ss:ExpandedColumnCount="11" ss:ExpandedRowCount="' . count($this->lines) . '" x:FullColumns="1"
   x:FullRows="1" ss:DefaultColumnWidth="65" ss:DefaultRowHeight="15">
   <Column ss:AutoFitWidth="0" ss:Width="145"/>
   <Column ss:Index="3" ss:AutoFitWidth="0" ss:Width="125"/>
